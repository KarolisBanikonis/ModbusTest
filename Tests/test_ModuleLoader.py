...
class test_ModuleLoader(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.module_loader = ModuleLoader(cls.registers.get_modules_data(),
            cls.ssh_client, cls.print_mod)
    ...
    def test_init_modules(self):
        calculated = self.module_loader.init_modules(self.registers.data,
            self.modbus, self.info, self.report)
